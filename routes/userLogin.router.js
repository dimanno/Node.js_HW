...
const {tokenTypeEnum:{REFRESH, ACCESS}, actionTokens:{ACTIVATE_USER}} = require('../config/constants');
...
router.get('/activate/:token', loginMiddleware.checkActionToken(ACTIVATE_USER), userLoginController.activateUser);
